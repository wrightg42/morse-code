...
namespace MoresCodeLibrary
{
    ...
    {
        /// <summary>
        /// The dictionary of all characters in morse code (true being a dash, false being a dot).
        /// </summary>
        public static const Dictionary<char, bool[]> MorseCharacterValues = new Dictionary<char, bool[]>() 
        {
